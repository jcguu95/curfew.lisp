...
(setf *url-list*
      '("www.youtube.com" "news.ycombinator.com" "www.reddit.com" "old.reddit.com"
...
(defun main ()
  ...
  (loop (sleep 4)
        (ignore-errors
         ...
         (cond
           ((time-within 2030 0230) (kill-user "jin"))
           ;; ((time-within 0230 0500) (slock-all "jin"))
           ;; ((time-within 0230 1700) (continue-user "jin"))
           ;; ((time-within 1700 1900) (kill-user "jin"))
           ((time-within 0230 2030) (continue-user "jin"))))))
